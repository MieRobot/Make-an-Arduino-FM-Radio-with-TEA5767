...
*/
// This code is production grade and has been tested with Arduino Uno
#include <Wire.h>
#include <TEA5767N.h>
...
//Variables:
int flag=0;
double stations[] = {91.9, 102.9, 101.3,92.7}; // Your station presets
int currentstation = 0;
int maxstation = 3; // Last item in the stations array (zero indexed)
bool mutestate = 0;
